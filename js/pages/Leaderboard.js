...
import { get_gsv_profile } from '../api.js';
...
export default {
            ...
            <div class="page-leaderboard">
                ...
                <div class="player-container">
                    <div class="player">
                        <h1>
                            #{{ selected + 1 }}
                            <a href="javascript:void(0)" @click.prevent="profileLink(entry.user)">
                                {{ entry.user }}
                            </a>
                        </h1>
    ...
    methods: {
        ...
        async profileLink(username) {
            const profile_id = await get_gsv_profile(username);
        
            if (profile_id) {
                window.open(
                    `https://globalstatsviewer.com/users/${profile_id}`,
                    '_blank'
                );
            }
        },
